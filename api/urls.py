...
from api.views import WalletListAPIView, WalletDetailAPIView, WalletUpdateAPIView, WalletDeleteAPIView, \
    WalletCreateAPIView
...
urlpatterns = (
    [
        ...
        path('v1/wallets/<int:pk>/operation/', WalletUpdateAPIView.as_view(), name='update'),
